...
uint8_t pin_led = 2;
char* ssid = "doesnotmatter"; //first time boot up as a AP-mode (Soft Access Point) then creat a web page to load new SSID/password to STA-mode (Station)
char* password = "joe50508";
char* mySsid = "Test_ESP8266";
